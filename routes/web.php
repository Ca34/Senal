...
Route::middleware('auth')->group(function () {
    ...
    // Rutas de administración (Acceso para admin y gestor)
    Route::middleware(['role:admin|gestor'])->prefix('admin')->group(function () {
    ...
    // Rutas exclusivas para administrador (Borrado)
